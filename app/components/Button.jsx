...
const Outline = (props) => {
  ...
  return (
    <TouchableOpacity onPress={onPress} style={{ ...mainStyle.button.outline, ...style }}>
      <Text style={{ ...mainStyle.button.textOutline, ...textStyle }}>{text}</Text>
    </TouchableOpacity>
  );
};

export { Regular, Dark, Outline };
